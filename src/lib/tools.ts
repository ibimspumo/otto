...
export const toolDefs = [
  ...
  },
  {
    ...
    name: "web_search",
    description:
      "Websuche über Brave Search. Die Ergebnisse erscheinen automatisch als Recherchefläche im Artefakt-Fenster (typisch rechts auf dem aktiven Bildschirm); du bekommst sie zusätzlich als JSON zurück. Nutze dies für aktuelle oder unsichere Fakten.",
    parameters: {
      type: "object",
      properties: {
