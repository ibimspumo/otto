...
export const toolDefs = [
  ...
  },
  {
    ...
    name: "run_terminal",
    description:
      "Führt einen sicheren, kurzen Shell-Befehl auf dem Mac aus (zsh) und liefert stdout/stderr/exit_code. Gedacht für harmlose Systemaufgaben wie Apps öffnen oder Status auslesen. Destruktive Befehle, Datei-Umleitungen, Downloads, Netzwerk-Shell-Pipelines, Rechteänderungen und freie AppleScript-Automation werden blockiert. Für alles, was länger als ~20 Sekunden dauern könnte, setze background=true: der Befehl läuft dann als Hintergrund-Job, du bekommst sofort eine job_id und bleibst ansprechbar; das Ergebnis kommt automatisch als Systemnachricht (abbrechen mit cancel_job).",
    parameters: {
      type: "object",
      properties: {
